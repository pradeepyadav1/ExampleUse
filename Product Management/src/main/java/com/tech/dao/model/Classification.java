 ...
 */
@Entity
@Table(name = "classifications", catalog = "product_management_bd")
public class Classification implements java.io.Serializable {

	private static final long serialVersionUID = 7734265083673037566L;
	...
	public String toString() {
		return "Classification [id=" + id + ", name=" + name + ", points="
				+ points + ", active=" + active + ", created=" + created
